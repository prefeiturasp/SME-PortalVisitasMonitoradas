...
class LoopParceiroRelacionados extends LoopParceiro
{
	...
	{
		$this->montaHtmlParceiroRelacionados();
	}
	public function montaHtmlParceiroRelacionados(){
	?>
	...
	<?php if($count_arrow > 0): ?>
		...
		<div class="row mt-2 mb-2">
			<div class="carousel-multiple-title col-sm-6">
				<h2 class="title-carousel-eventos">Agenda de eventos</h2>
			</div>
