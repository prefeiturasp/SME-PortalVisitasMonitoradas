...
function redirect_to_specific_page() {
	...
	if ( is_page('inscricoes') && ! is_user_logged_in() ) {
		wp_redirect( 'https://visitasmonitoradas.sme.prefeitura.sp.gov.br/login/?eventoid=' . $_GET['eventoid'], 301 ); 
  		exit;
...
function export_btn() {
    ...
    if ($typenow == 'agendamento') {
        ...
        <div class="alignright">
            <form method='get' action="<?= get_template_directory_uri(); ?>/export-inscricoes-excel.php">
...
function every_day_exec_event_func() {	
	...
	if ( $the_query->have_posts() ) {
		...
		while ( $the_query->have_posts() ) {
			...
			$body .= '<p><a href="https://visitasmonitoradas.sme.prefeitura.sp.gov.br/avaliacao?evento_id=' . get_the_ID() . '">https://visitasmonitoradas.sme.prefeitura.sp.gov.br/avaliacao?evento_id=' . get_the_ID() . '</a></p>';
